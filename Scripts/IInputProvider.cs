...
public interface IInputProvider
{
    ...
    /// <summary>
    /// Gets a normalized movement direction in 3D world space.
    /// Takes into account camera orientation for player input.
    /// For AI, this is the desired world movement direction.
    /// </summary>
    Vector3 GetWorldMovementDirection();
}
